...
$ issue config --global set author.email "gamitamon@gmail.com"
$ issue config --global set author.name "Amonjr"
...
issue deadbeefd2eece78dbf8f98e357ba0af65f7e180
opened by:    Amonjr (gamitamon@gmail.com), on 1970-01-01 23:59:59.000000
...
- [`CLAP`](https://github.com/Amonjr/clap): at least `0.15.0` (must be installed from Git)
